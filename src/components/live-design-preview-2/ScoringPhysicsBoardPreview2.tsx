...
// live-design-preview/ScoringPhysicsBoardPreview.tsx（1個目のデザイン確認）を、
// 大喜利素材2のネオン系配色に合わせて見た目だけ差し替えたコピー。
// 物理演算・玉のロジックは一切変更していない（差分は外枠の配色と「お題」ラベルの見せ方のみ）。
export default function ScoringPhysicsBoardPreview2({
  topicBody,
  roundLabel,
  ...
  return (
    <div ref={containerRef} className="relative h-full w-full">
      <div className="absolute inset-0 overflow-hidden rounded-[28px] border-[5px] border-[#3b5bff] bg-white shadow-[0_0_40px_rgba(59,91,255,0.45)]">
        ...
        {/* 「お題」ラベルは枠の外にはみ出すピルタブではなく、枠内左上に収める。 */}
