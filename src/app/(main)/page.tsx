      ...
      <section>
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <NavTile
            ...
            flavorText="寄席のくじ引きにちなんだ抽選コーナーです。ライブなどで貯まったポイントを使ってくじを引くと、衣装・アイコンパーツ・背景柄のいずれかがランダムで当たります（レアリティはN・R・SR・SSRの4段階）。1回引きだけでなく10連引きもでき、当たったアイテムはそのまま「楽屋」で身につけられます。狙ったアイテムを個別に買いたいときは、同じ画面内の「衣装蔵（ショップ）」タブから購入できます。"
          />
          <NavTile
            href="/backstage-room"
            emoji="🚪"
            ...
            flavorText="出番前後の演者が身支度をする控室です。所持している衣装・アイコンパーツ・背景柄のカードをタップするだけで、その場ですぐに着せ替え・模様替えができます。画面上部の「楽屋挨拶に行く」から他の演者の楽屋にもお邪魔でき、部屋の中で「おはようございます」「よろしくお願いします」と挨拶を送ることもできます。"
          />
          <NavTile
            href="/ranking"
            emoji="🏆"
            ...
            flavorText="相撲や寄席の番付になぞらえた、道場に集う演者たちの序列表です。段位（見習い〜達人の8段階）と通算スコアの順に並び、自分の順位もひと目で確認できます。同じ画面の「過去のライブ」タブでは、過去に開催されたライブのお題・回答をいいね数順に振り返ることもできます。"
          />
          <NavTile
            href="/sns"
            emoji="📔"
            ...
            flavorText="楽屋雀たちが世間話やお題のやり取りを書き留める、寄席の「寄合帳」にちなんだ交流ノートです。お題や回答を自由に投稿でき、新着・人気・フォロー中で絞り込んで眺められます。気になる演者をフォローしたり、回答に「ツッコミ」というコメントを送ったりもできます。"
          />
        </div>
      </section>
    </>
